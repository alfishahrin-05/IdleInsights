          ...
          <div className="card">
            ...
            <div style={{
              ...
              <ul style={{ margin: 0, paddingLeft: '1.5rem', fontSize: '0.9rem', lineHeight: '1.6' }}>
                <li>Work for exactly {timeBoxMinutes} minutes</li>
                <li>Checkpoints at 25%, 50%, 75% ask: "Is this good enough?"</li>
                <li>At 100%, task is automatically marked complete</li>
                <li>Motivational reminders combat perfectionism</li>
              </ul>
            </div>
